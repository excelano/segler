...
@{
    ...
    #
    #   Get-AppxPackage Excelano.Segler
    #   https://apps.microsoft.com/detail/9P2C2QWHSDJL
    PackageFamilyName = 'Excelano.Segler_nbxmgv0sk86m4'
    StoreId = '9P2C2QWHSDJL'
}
