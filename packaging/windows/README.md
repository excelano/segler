...
| `screenshot.ps1` | Photographs the window at a size the Store accepts, driving it first if asked. Generated by ship; edit the template |
...
is one product; the Store package is the window. The CLI ships
through cargo-dist.
